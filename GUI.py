...
class MainUI(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            print("File not found: nameslist.txt")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='./Resources/homepagepic.png')
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.user_name = tk.Entry(self, borderwidth=3, bg="lightgrey", font='Helvetica 11')
        self.user_name.grid(row=0, column=1, pady=10, padx=10)
        self.buttoncanc = tk.Button(self, text="Cancel", command=self.cancel, bg="#ffffff", fg="#263942")
        self.buttonclear = tk.Button(self, text="Clear", command=self.clear, fg="#ffffff", bg="#263942")
        self.menuvar = tk.StringVar(self)

        # Check if names is not empty before creating the OptionMenu
        if names:
            self.dropdown = tk.OptionMenu(self, self.menuvar, *names)
        else:
            # If names is empty, create an OptionMenu with a default value
            self.dropdown = tk.OptionMenu(self, self.menuvar, "")
    ...
    def next_foo(self):
        if self.user_name.get() == "" and self.menuvar.get() == "":
            messagebox.showerror("ERROR", "Name cannot be 'None'")
            return
...
class PageThree(tk.Frame):
    ...
    def trainmodel(self):
        ...
        names.add(self.controller.active_name)
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button4 = tk.Button(self, text="Go to Home Page", command=self.clear, bg="#ffffff", fg="#263942")
...
app = MainUI()
app.iconphoto(True, tk.PhotoImage(file='./Resources/icon.ico'))
app.mainloop()
